...
RRK_MODEL = os.getenv("RRK_MODEL", 'cross-encoder/ms-marco-MiniLM-L-12-v2')
nb_workers = int(os.getenv("nb_workers", '8'))
...
class Index:
    ...
    def __init__(
        ...
        self.type = type
        self.reranking_model = CrossEncoder(RRK_MODEL, max_length=512)
